...
const DEFAULT_BAICHUAN_URL = isApp ? BAICHUAN_BASE_URL : ApiPath.Baichuan;
...
const DEFAULT_ACCESS_STATE = {
  ...
  // baichuan
  baichuanUrl: DEFAULT_BAICHUAN_URL,
  baichuanApiKey: "",
...
export const useAccessStore = createPersistStore(
  ...
  (set, get) => ({
    ...
    isValidBaichuan() {
      return ensure(get(), ["baichuanApiKey"]);
    },

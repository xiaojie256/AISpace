...
export const getServerSideConfig = () => {
  ...
  const isHuggingFace = !!process.env.HUGGINGFACE_API_KEY;
  ...
  return {
    ...
    isHuggingFace,
    huggingfaceUrl: process.env.HUGGINGFACE_URL,
    huggingfaceApiKey: getApiKey(process.env.HUGGINGFACE_API_KEY),
